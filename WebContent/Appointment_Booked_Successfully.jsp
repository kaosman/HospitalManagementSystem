...
<title>project_Latest We_Care_2011-11-15_10h55m17s - Appointment
	Booked Successfully</title>
</head>
<body>
...
%>
	...
	<div id="s-d9d35f6d-714d-4459-ac67-b95608d20e35">
		<input id="screenName" type="hidden"
			value="Appointment Booked Successfully" /><input id="canvases"
			type="hidden"
			value="s-d9d35f6d-714d-4459-ac67-b95608d20e35?t-70f2be6c-31aa-4006-9a58-4bf50f104708" />
		<link rel="stylesheet" charset="utf-8"
			href="css/screens/Appointment%20Booked%20Successfully.css" />
		<link rel="stylesheet" charset="utf-8"
			href="css/templates/Nurse%20Template.css" />
		<!--[if IE]><link rel="stylesheet" charset="utf-8" href="css/screens/Appointment%20Booked%20Successfully-ie.css"/><link rel="stylesheet" charset="utf-8" href="css/templates/Nurse%20Template-ie.css"/><![endif]-->
		<div
		...
		<div
			class="s-d9d35f6d-714d-4459-ac67-b95608d20e35 screen firer commentable">
			...
			<img id="s-Image_1" class="image firer commentable" alt="image"
				src="images/0-%20services_banner_appointment_scheduling.jpg" /><img
				id="s-Image_3" class="image firer commentable" alt="image"
				src="images/8-%20images%20(4).jpg" />
			<div id="s-Rich_text_4" class="richtext firer commentable">
				<div id="s-Rich_text_4-container">
					<table class="collapse" style="height: 100%; width: 100%;"
						...
						<tbody>
							<tr>
								<td><span id="s-Rich_text_4_0"><%= appointment.getDate() %></span></td>
							</tr>
						</tbody>
					</table>
				</div>
			...
			<div id="s-Rich_text_5" class="richtext firer commentable">
				<div id="s-Rich_text_5-container">
					<table class="collapse" style="height: 100%; width: 100%;"
						...
						<tbody>
							<tr>
								<td><span id="s-Rich_text_5_0"><%= appointment.getTime() %></span></td>
							</tr>
						</tbody>
					</table>
				</div>
