...
<meta name="description"
	content="Generated by Justinmind on Thu Nov 17 23:40:41 EST 2011" />
<title>project_Latest We_Care_2011-11-15_10h55m17s - Book
	appointment</title>
</head>
<body>

<%
	ArrayList<String> doctorNames = (ArrayList<String>)session.getAttribute("doctors"); 
%>

	<div id="s-adf29b66-b823-4f03-a3ca-b0f66dca0a1b">
		<input id="screenName" type="hidden" value="Book appointment" /><input
			id="canvases" type="hidden"
			value="s-adf29b66-b823-4f03-a3ca-b0f66dca0a1b?t-70f2be6c-31aa-4006-9a58-4bf50f104708" />
		<link rel="stylesheet" charset="utf-8"
			href="css/screens/Book%20appointment.css" />
		<link rel="stylesheet" charset="utf-8"
			href="css/templates/Nurse%20Template.css" />
		<!--[if IE]><link rel="stylesheet" charset="utf-8" href="css/screens/Book%20appointment-ie.css"/><link rel="stylesheet" charset="utf-8" href="css/templates/Nurse%20Template-ie.css"/><![endif]-->
		<div
		...
		<div
			class="s-adf29b66-b823-4f03-a3ca-b0f66dca0a1b screen firer commentable">
			...
			<div id="s-Input_1" class="inputtext firer commentable">
				...
				<option value="<%=doctorNames.get(i)%>"><%= doctorNames.get(i) %></option> <% } %>
				</select>
			</div>
