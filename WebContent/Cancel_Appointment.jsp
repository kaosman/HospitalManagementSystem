...
<meta name="description"
	content="Generated by Justinmind on Thu Nov 24 18:37:41 EST 2011" />
<title>changed prototype - Cancel Appointment</title>
</head>
<body>
	<div id="s-93853484-54f8-456f-a37c-2e55a2518cce">
		<input id="screenName" type="hidden" value="Cancel Appointment" /><input
			id="canvases" type="hidden"
			value="s-93853484-54f8-456f-a37c-2e55a2518cce?t-70f2be6c-31aa-4006-9a58-4bf50f104708" />
		<link rel="stylesheet" charset="utf-8"
			href="css/screens/Cancel%20Appointment.css" />
		<link rel="stylesheet" charset="utf-8"
			href="css/templates/Nurse%20Template.css" />
		<!--[if IE]><link rel="stylesheet" charset="utf-8" href="css/screens/Cancel%20Appointment-ie.css"/><link rel="stylesheet" charset="utf-8" href="css/templates/Nurse%20Template-ie.css"/><![endif]-->
		<div
		...
		<div
			class="s-93853484-54f8-456f-a37c-2e55a2518cce screen firer commentable">
			...
			<form action ="CancelAppointmentConfirmation" method="post">
			...
			<div id="s-Label_27" class="label firer commentable">Cancel
				Appointment</div>
			
			<div id="s-Button_2" class="button firer commentable"><input type="submit" value="Next" /></div>
			<div id="s-Label_4" class="label firer commentable">Doctor Name</div>
			<div id="s-Input_2" class="inputtext firer commentable">		
			<select name="doctor">
			<% ArrayList<String> doctors = (ArrayList<String>)session.getAttribute("doctors");
			   for (int i = 0; i < doctors.size(); i++) {%>
				<option value="<%= doctors.get(i) %>"><%= doctors.get(i) %></option>
			<% } %>
			</select>
	
			</div>
			<div id="s-Label_16" class="label firer commentable">-</div>
...
<option value="31">31</option>
			...
			<div id="s-Label_1" class="label firer commentable">:</div>
